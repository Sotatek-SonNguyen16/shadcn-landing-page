...
const BuyForm: React.FC = () => {
    const {formType, betOption, selectedEvent, changeBetOption} = useEventContext()
        ...
        [EFormType.MARKET]: <>
            <div className={`mb-3`}>
                <div>
                    ...
                    <div className={`flex justify-around px-3 py-2 border border-gray-300 rounded-lg`}>
                        <IconButton><Minus width={15} height={15}/></IconButton>
                        <input className={clsx(
                            "text-center",
                            "focus:border-none"
                        )} placeholder={`$0`}/>
                        <IconButton><Plus width={15} height={15}/></IconButton>
                    </div>
                </div>
            </div>
            <div className={'flex mb-3'}>
                <Button className={`flex-1`} variant={`primary`}>Login</Button>
            </div>
            <div>
                <DataList.Root>
                    <DataList.Item align="center">
                        <DataList.Label minWidth="88px">Avg price</DataList.Label>
                        <DataList.Value>
                            <div className={`w-full text-end text-blue-500`}>
                                <span className={`border-dotted border-b-2 border-sky-500 cursor-pointer`}>
                                    0.0#
                                </span>
                            </div>
                        </DataList.Value>
                    ...
                    <DataList.Item align="center">
                        <DataList.Label minWidth="88px">Shares</DataList.Label>
                        <DataList.Value>
                    ...
                    <DataList.Item align="center">
                        <DataList.Label minWidth="88px">Potential</DataList.Label>
                        <DataList.Value>
                            <div className={`w-full text-end text-green-500`}>
                                0.0#
                            </div>
                        </DataList.Value>
                    </DataList.Item>
        ...
        [EFormType.LIMIT]: <>
            ...
            <div>
                <DataList.Root>
                    ...
                    <DataList.Item align="center">
                        <DataList.Label minWidth="88px">Potential return</DataList.Label>
                        <DataList.Value>
                            <div className={`w-full text-end text-green-500`}>
                                0.0#
                            </div>
