...
const PredictionCard: React.FC = () => {
    const src = 'https://polymarket.com/_next/image?url=https%3A%2F%2Fpolymarket-upload.s3.us-east-2.amazonaws.com%2Fwill-kamala-harris-win-the-2024-us-presidential-election-21483ac3-94a5-4efd-b89e-05cdca69753f.png&w=96&q=100'
    const {changeForm, changeType, formType} = useEventContext()
    const formTypeList: EFormType[] = Object.values(EFormType);


    return (
        <div className={`w-[338px] h-fit bg-card rounded-xl border-[1px] border-gray-200 shadow-lg`}>
